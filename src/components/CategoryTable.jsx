    ...
    return (
        <>
            {show && <div className='max-w-sm mx-auto fixed left-3/6 bg-gray-400 p-10 top-30 -translate-x-3/6'>
                <div class="mb-5">
                    <label for="email"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Category Name</label>
                ...
                <div class="mb-5">
                    <label for="repeat-password"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Discription</label>
                    <input type="password" id="repeat-password" class="shadow-xs bg-gray-50 border
            ...
            <div className='flex justify-end p-4'>
                <button onClick={() => { setshow(true); editCategory(); seteditid(null) }} className='p-4 bg-green-400 rounded-2xl font-bold'>Add +</button>
            </div>
                        ...
                        {category.map((i, index) =>
                            <tr key={index}>
                                ...
                                <td className='w-full flex flex-col p-1 gap-2 items-center justify-center '>
                                    <button className='w-20 h-8 rounded text-black font-bold  bg-green-600' onClick={() => { saveproduct(i._id) }}>Edit</button>
