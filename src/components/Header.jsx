            ...
            <div className='flex gap-5 items-center'>
                {Logging ? (
                    <Link onClick={() => { userlogout() }} className='flex gap-2 hover:bg-red-600 p-4 rounded-lg group' to={"/"}>
                        <img src={dpicon} alt="" className='group-hover:invert' />
                        <h3>Logout</h3>
                        <img src={arrowicon} alt="" className='group-hover:rotate-180 g' />
                    </Link>) : (<Link className='flex gap-2 hover:bg-blue-600 p-4 rounded-lg group' to={"/login"}><img src={dpicon} alt="" className='group-hover:invert' />
